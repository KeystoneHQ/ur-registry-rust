...
#[no_mangle]
pub extern "C" fn solana_crypto_multi_accounts_get_master_fingerprint(
...
#[no_mangle]
pub extern "C" fn solana_crypto_multi_accounts_get_device(
    crypto_multi_accounts: &mut CryptoMultiAccounts,
) -> PtrResponse {
...
#[no_mangle]
pub extern "C" fn solana_crypto_multi_accounts_get_keys_len(
    crypto_multi_accounts: &mut CryptoMultiAccounts,
) -> PtrResponse {
...
#[no_mangle]
pub extern "C" fn solana_crypto_multi_accounts_get_key(
    crypto_multi_accounts: &mut CryptoMultiAccounts,
    index: u32,
) -> PtrResponse {
